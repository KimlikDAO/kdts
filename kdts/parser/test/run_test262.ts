...
import { TsParser as parser } from "../tsParser"

type RunnerSourceType = "module" | "script"
...
run((content: string, { sourceType }: RunnerContext): ReturnType<typeof parser.parse> => {
